...
HASHED_PASSWORD = "83d8d394e2f34565fab84e6a303cd166fb32eb01fe9e0f1302daa01eabe9b7f8"
...
""", unsafe_allow_html=True)
    ...
    for i in range(0, len(image_files), cols_per_row):
        ...
        for col_idx, image_item in enumerate(row_images):
            with cols[col_idx]:
                ...
                image_key = f"image_{i}_{col_idx}"
                    ...
                    if st.session_state[f"decrypted_{image_key}"]:
                        ...
                        try:
                            ...
                            st.image(image, use_container_width=True,
                                    caption=f"Beautiful memories with ANNA - {image_item}")
                        ...
                        if st.session_state[f"decrypted_{video_key}"]:
                            ...
                            try:
                                ...
                                st.markdown(f"""
                                    <div class="video-container">
                                        <div class="video-title">Video {video_idx + 1} - Cute ANNA Moments! 💜</div>
                            ...
                            st.markdown(f"""
                                <div class="video-container">
                                    ...
                                    <p style="font-family: 'Montserrat', sans-serif; font-size: 0.9rem; color: #b0b0b0; text-align: center;">
                                        Click decrypt to unlock ANNA's cute moments!
                                    </p>
                                </div>
                            """, unsafe_allow_html=True)
                    else:
